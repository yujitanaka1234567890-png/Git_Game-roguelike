...
Game.config = {
  ...
  mind: {
    ...
    graceTurns: 165, // 長居の猶予（ふつうの広さの階で）。これを超えて同じ階に居続けると…
    ...
    zeroDamage: 2, // 精神力が0の間、毎ターン受けるダメージ（最初の値）
    zeroDoubleEvery: 10, // 精神力0が続くと、このターン数ごとにダメージが倍になる（1以上に戻ればリセット）
...
Game.STAIRS = {
  ">": { dir: [0, 1], key: "↓", action: "descend", verb: "降りる", label: "階段" },
  "O": { dir: [0, 1], key: "↓", action: "escape", verb: "脱出する", label: "脱出口" }, // 各ダンジョンの最深部にある
